...
function Strategy(options, verify) {
  ...
  this._clientIdField = options.clientIdField ? options.clientIdField : 'client_id';
  this._clientSecretField = options.clientSecretField ? options.clientSecretField : 'client_key';
}
...
Strategy.prototype.authenticate = function(req) {
  if (!req.body || (!req.body[this._clientIdField] || !req.body[this.clientSecretField])) {
    return this.fail();
  }

  var clientId = req.body[this._clientIdField];
  var clientSecret = req.body[this._clientSecretField];
